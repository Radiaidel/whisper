<div class="flex justify-between items-center">
    <div class="flex flex-col">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div>
                <div class="font-semibold text-lg">{{auth()->user()->name . '3010'}}</div>
        ...
        <div class="flex mt-4">
            ...
            <a href="" class="text-blue-600 mr-4">https://www.youtube.com/watch?v=4jnA9_at9wQ</a>
    ...
    <div class="flex items-center">
        ...
        <img src="https://cdn.ttgtmedia.com/rms/misc/qr_code_barcode.jpg" alt="Code QR" class="w-20 h-20 ml-4">
